...
class ActivityClusterer(AbstractClusterer):
    ...
    def __init__(self, col_name):
        ...
        self._set_abstraction(None)

    def build_abstractions(self, col_name) -> dict:
        return {
            "activity_abstracted": (col_name, ActivityAbstraction(col_name, col_name, instance_clusterer.abstract_instance_complete, 0)),
            "activity_bygroup": (col_name, ActivityAbstraction("org:group", col_name, instance_clusterer.abstract_instance, 1)),
            "activity_not_abstracted": (col_name, ActivityAbstraction(col_name, col_name, instance_clusterer.abstract_instance, 100)),
        }
