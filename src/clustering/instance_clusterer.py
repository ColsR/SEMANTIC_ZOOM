...
class InstanceClusterer(AbstractClusterer):
    ...
    def build_abstractions(self, col_name):
        return {
            f'misc{col_name}_abstracted': (col_name, InstanceAbstraction(col_name, col_name, abstract_instance_complete, 0)),
            f'misc{col_name}_not_abstracted': (col_name, InstanceAbstraction(col_name, col_name, abstract_instance, 100)),
        }
